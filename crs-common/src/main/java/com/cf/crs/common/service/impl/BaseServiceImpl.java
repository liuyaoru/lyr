...
package com.cf.crs.common.service.impl;
...
public abstract class BaseServiceImpl<M extends BaseMapper<T>, T>  implements BaseService<T> {
    ...
    public boolean deleteOnStatus(Long id) {
        return SqlHelper.delBool(baseDao.update(null,new UpdateWrapper<T>().eq("id", id).set("status",  0)));
    }
